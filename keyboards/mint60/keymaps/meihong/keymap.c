...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_ESC,    KC_LALT,    KC_LGUI,    KC_LANG2,    KC_SPC,        KC_SPC, KC_LANG1,  KC_CAPS,               KC_LEFT,KC_DOWN,KC_RGHT \
  ),
  [1] = LAYOUT( \
    ...
    _______,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, LALT(KC_PGUP), _______, \
